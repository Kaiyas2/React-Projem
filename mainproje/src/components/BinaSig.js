...
function BinaSig() {
  return (
    <div className='bina-resim'>
        <div className='kefalet-yazi'>
...
<label>
    ...
    tüketicilerin ödemelerini teminat altına almak ve ülke ekonomisine yeni gayrinakdi
</label>
<label>
