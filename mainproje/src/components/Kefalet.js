...
function Kefalet() {
  return (
    ...
    <p>Kaiya Sigorta, özellikle Kamu ihale süreçlerinde özel sektörün teminat ihtiyaçlarını karşılayabilmek,
         </p>
          ...
          bu şekilde kredi limitlerinin başka
           ...
           <p>Türkiye’de bir ilk olarak firmalar ihalelere katılırken teminat mektubu yerine
             Kaiya Sigorta Kefalet Sigortası kapsamında</p>
             <p> düzenlenen kefalet senetlerini sunabiliyorlar.</p>
            </div>
             <div className='sag-bar'>
                <h3>Kaiya Sigorta'dan Bir İlk!</h3>
                ...
                <label>Kaiya Sigorta kefalet senetlerini online olarak teyit edebilirsiniz.</label>
                <button className='sag-bar-btn2'>Kaiya Sigorta Üzerinden Kayıt</button>
